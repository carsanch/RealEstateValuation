...
package com.carlossamartin.realestatevaluation;

import com.carlossamartin.realestatevaluation.controller.RealEstateOverviewController;
import com.carlossamartin.realestatevaluation.controller.RootLayoutController;
import com.carlossamartin.realestatevaluation.controller.SettingsViewController;
import com.carlossamartin.realestatevaluation.model.HomeTable;
...
public class MainApp extends Application {
    ...
    private final static String TITLE_APP = "RealEstateValuation";

    private Stage primaryStage;
    private BorderPane rootLayout;

    private RealEstateOverviewController realEstateOverviewController;
     ...
     */
    public void showRealEstateOverview() {
        try {
            // Load person overview.
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(MainApp.class.getResource("/view/RealEstateOverview.fxml"));
            AnchorPane realEstateOverview = (AnchorPane) loader.load();

            // Set person overview into the center of root layout.
            rootLayout.setCenter(realEstateOverview);

            // Give the controller access to the main app.
            realEstateOverviewController = loader.getController();
            realEstateOverviewController.init(this);
    ...
    public void loadWrapperFromFile(File file) {
        ...
        try {
            ...
            realEstateOverviewController.setHomeTableFromHomeTableWrapper(wrapper);
    ...
    public void clearData() {
        realEstateOverviewController.clearData();
    }

    public HomeTableWrapper loadWrapperFromTable() {
        return realEstateOverviewController.getHomeTableWrapperFromHomeTable();
    }

    public TableView<HomeTable> getHomeTable() {
        return realEstateOverviewController.getHomeTable();
    }
}
